...
export interface Vehicle { id: Id; registrationPlate: string; make: string; model: string; year: number; payloadCapacityKg: number; hasRamp: boolean; }
...
export interface VehicleMileage { vehicleId: Id; registrationPlate: string; totalDistanceKm: number; }
